---
title: 'Additional sensitivity analyses: NOAA Climate Region, RUCA, Intersection of AI definitions'
...
See code below for additional plots included in the supplement.
...
ggsave("figures/supplement/model_interx_climate.png")

```

# Comparing NCHS and RUCA Rural Counties
...
ggsave("figures/supplement/ruca_monitor_interx_plot.png")
...
ggsave("figures/supplement/ruca_model_interx_plot.png")
...
```{r}
all_overlap_vctr = all_overlap %>% pull(GEOID)
...
ggsave("figures/supplement/model_interx_no_covariates.png")
...
# save without grob
model_adi_interx_plot
ggsave("figures/supplement/model_adi_interx.png")
```
