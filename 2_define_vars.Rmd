...
```{r save out AI county classifications as separate file}
setwd("/Users/maggieli/OneDrive - cumc.columbia.edu/QE/QE_power_calculations")
write_csv(main_analysis_counties,
        "ai_county_classification.csv")
write_csv(all_native_counties,
          "ai_counties.csv")
write_csv(all_general_counties,
          "nai_counties.csv")
```
