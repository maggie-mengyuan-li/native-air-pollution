...
##3.1 Rural Counties (Main Analysis subset) 9/3/2021 ALREADY DID THIS IN 7_STAT_ANALYSIS
...
##3.1.1 Re-read in Model PM2.5 data (need to run this chunk before everything below due to overwriting variable name due to new definitions of county type) 
```{r}
