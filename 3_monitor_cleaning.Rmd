...
Note: Monitor coverage (Section 3.1) is not included in the present edition of our paper, but you can take a look to see how monitor coverage differs between AI- and non-AI-populated counties. 
...
#### 3.1.2.1 Chi-Squared test to compare monitor distributions
```{r}
...
Next off, we need to clean the data further to have estimates for our Table 1, descriptive PM2.5 trends by county and state over time, and statistical regression models. 
