...
I also run Model 4 to test for potential effect modification of AI/Non-AI county type classification by categorical year, i.e., including an interaction term for county_type*year.
...
#### Plot time-varying effect of AI/Non-AI county type binary variable (county_type x year interaction term)
...
var(x+y) = var(x) + var(y) + 2*covar(x,y) where x = main effect of native county type on PM2.5 concentrations in 2000 (referent), y = main effect of native county type due to interaction with time in study years 2001-2018
...
ggsave("figures/interx_plot/monitor_interx.pdf", width = 6, height = 4, dpi = 300)
...
ggsave("figures/interx_plot/monitor_rural_interx.png", width = 6, height = 4, dpi = 300)
```
...
ggsave("figures/interx_plot/model_interx.pdf", width = 6, height = 4, dpi = 300)

# save without grob
model_interx_plot
ggsave("figures/interx_plot/model_interx.pdf", width = 6, height = 4)

library(ggpubr)
ggarrange(model_interx_grob, monitor_interx_grob)
ggsave("figures/interx_plot/model_monitor_interx.pdf", width = 12, height = 4, dpi = 300)
# 
# # save without grob for F31 prelim data
# model_interx_plot
# ggsave("figures/interx_plot/model_interx.png")
```
...
ggsave("figures/interx_plot/model_rural_interx.png", width = 6, height = 4, dpi = 300)
```
