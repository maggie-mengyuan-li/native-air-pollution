...
### 9/6 update: plotting adjusted lines w/ nested random effects!
...
### Extra: more on how predict works ###
...
sex
ldose
predict(budworm.lg, type = "link") # returns f(x)
predict(budworm.lg, type = "response") # returns e^(f(x)), i.e. predicted probabilities
predict(budworm.lg, type = "terms") # returns a matrix given fit of each observation on linear scale(??)
