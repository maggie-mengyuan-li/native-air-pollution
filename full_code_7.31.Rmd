...
annual_conc_by_monitor_1999 <- read_csv("annual_conc_by_monitor_1999.csv")
annual_conc_by_monitor_2000 <- read_csv("annual_conc_by_monitor_2000.csv")
annual_conc_by_monitor_2001 <- read_csv("annual_conc_by_monitor_2001.csv")
annual_conc_by_monitor_2002 <- read_csv("annual_conc_by_monitor_2002.csv")
annual_conc_by_monitor_2003 <- read_csv("annual_conc_by_monitor_2003.csv")
annual_conc_by_monitor_2004 <- read_csv("annual_conc_by_monitor_2004.csv")
annual_conc_by_monitor_2005 <- read_csv("annual_conc_by_monitor_2005.csv")
annual_conc_by_monitor_2006 <- read_csv("annual_conc_by_monitor_2006.csv")
annual_conc_by_monitor_2007 <- read_csv("annual_conc_by_monitor_2007.csv")
annual_conc_by_monitor_2008 <- read_csv("annual_conc_by_monitor_2008.csv")
annual_conc_by_monitor_2009 <- read_csv("annual_conc_by_monitor_2009.csv")
annual_conc_by_monitor_2010 <- read_csv("annual_conc_by_monitor_2010.csv")
annual_conc_by_monitor_2011 <- read_csv("annual_conc_by_monitor_2011.csv")
annual_conc_by_monitor_2012 <- read_csv("annual_conc_by_monitor_2012.csv")
annual_conc_by_monitor_2013 <- read_csv("annual_conc_by_monitor_2013.csv")
annual_conc_by_monitor_2014 <- read_csv("annual_conc_by_monitor_2014.csv")
annual_conc_by_monitor_2015 <- read_csv("annual_conc_by_monitor_2015.csv")
annual_conc_by_monitor_2016 <- read_csv("annual_conc_by_monitor_2016.csv")
annual_conc_by_monitor_2017 <- read_csv("annual_conc_by_monitor_2017.csv")
annual_conc_by_monitor_2018 <- read_csv("annual_conc_by_monitor_2018.csv")
```
...
IMPROVE_location_tbl <- read_csv("/Users/maggieli/Dropbox/Native Air Pollution Paper/Paper/CodeCheck/native-air-pollution/Data/IMPROVE_location_tbl.csv")
...
yr = 2000
for (i in 1:19){
  model_PM25[[i]] <- read_csv(file = paste('model_PM25_', yr, '.csv', sep = ''))
...
counties_cluster <- read_csv("/Users/maggieli/Dropbox/Native Air Pollution Paper/Paper/CodeCheck/native-air-pollution/Data/clustershare.csv")
...
setwd("/Users/maggieli/Dropbox/Native Air Pollution Paper/Paper/CodeCheck/native-air-pollution/Data")
urban_rural_counties_2013 <- read_csv("urban_rural_counties_2013.csv")
...
census_pop_density <- read_csv("census_2010_pop_density.csv")
...
setwd("/Users/maggieli/Dropbox/Native Air Pollution Paper/Paper/CodeCheck/native-air-pollution/Data")
climatezonefips <- read_csv("climatezonefips.csv")
climatezonefips
...
eparegions <- read_csv("eparegions.csv")
...
# Join altogether
covariates <- inner_join(urban_rural_counties_2013, census_pop_density) %>%
...
# vcov matrix of main effects and interX
summary(detrend_lmer_full_catyr_intx(all_ctyear_exp))
native_yr_vcov <- vcov(detrend_lmer_full_catyr_intx(all_ctyear_exp))[c(2,seq(39,56)), c(2,seq(39,56))]
...
pm_decline_monitor_all[1,1] <- summary(detrend_lmer_full_catyr_intx(all_ctyear_exp))$coefficients[2,1]
pm_decline_monitor_all[1,2] <- summary(detrend_lmer_full_catyr_intx(all_ctyear_exp))$coefficients[2,1] - sd_vector[1]
pm_decline_monitor_all[1,3] <- summary(detrend_lmer_full_catyr_intx(all_ctyear_exp))$coefficients[2,1] + sd_vector[1]

# fill in matrix thru loop for every following year
yr_ct <- 39
for (i in 2:19){
  pm_decline_monitor_all[i,1] <- summary(detrend_lmer_full_catyr_intx(all_ctyear_exp))$coefficients[2,1]+
    summary(detrend_lmer_full_catyr_intx(all_ctyear_exp))$coefficients[yr_ct,1]
  
  pm_decline_monitor_all[i,2] <- summary(detrend_lmer_full_catyr_intx(all_ctyear_exp))$coefficients[2,1]+
    summary(detrend_lmer_full_catyr_intx(all_ctyear_exp))$coefficients[yr_ct,1] - sd_vector[i]
  
  pm_decline_monitor_all[i,3] <- summary(detrend_lmer_full_catyr_intx(all_ctyear_exp))$coefficients[2,1]+
    summary(detrend_lmer_full_catyr_intx(all_ctyear_exp))$coefficients[yr_ct,1] + sd_vector[i]
  yr_ct <- yr_ct + 1
}
...
#####4.1.1.3.2 Rural Main Analysis Counties
```{r}
# Year as a categorical variable
...
summary(detrend_lmer_full_catyr_intx(rural_monitors))
native_yr_vcov <- vcov(detrend_lmer_full_catyr_intx(rural_monitors))[c(2,seq(38,55)), c(2,seq(38,55))]
...
pm_decline_monitor_rural[1,1] <- summary(detrend_lmer_full_catyr_intx(rural_monitors))$coefficients[2,1]
pm_decline_monitor_rural[1,2] <- summary(detrend_lmer_full_catyr_intx(rural_monitors))$coefficients[2,1] - sd_vector[1]
pm_decline_monitor_rural[1,3] <- summary(detrend_lmer_full_catyr_intx(rural_monitors))$coefficients[2,1] + sd_vector[1]

# fill in matrix thru loop for every following year
yr_ct <- 38
for (i in 2:19){
  pm_decline_monitor_rural[i,1] <- summary(detrend_lmer_full_catyr_intx(rural_monitors))$coefficients[2,1]+
    summary(detrend_lmer_full_catyr_intx(rural_monitors))$coefficients[yr_ct,1]
  pm_decline_monitor_rural[i,2] <- summary(detrend_lmer_full_catyr_intx(rural_monitors))$coefficients[2,1]+
    summary(detrend_lmer_full_catyr_intx(rural_monitors))$coefficients[yr_ct,1] - sd_vector[i]
  pm_decline_monitor_rural[i,3] <- summary(detrend_lmer_full_catyr_intx(rural_monitors))$coefficients[2,1]+
    summary(detrend_lmer_full_catyr_intx(rural_monitors))$coefficients[yr_ct,1] + sd_vector[i]
  yr_ct <- yr_ct + 1
}
...
native_yr_vcov <- vcov(detrend_lmer_full_catyr_intx(model_lmer))[c(2,seq(39,56)), c(2,seq(39,56))]
# calculate all the variances for all the years i.e. var(x+y); should be 19 total entries
var_vector = c()
for (i in 2:19){
  var_vector[1] <- native_yr_vcov[1,1]
...
pm_decline_model_all[1,1] <- summary(detrend_lmer_full_catyr_intx(model_lmer))$coefficients[2,1]
pm_decline_model_all[1,2] <- summary(detrend_lmer_full_catyr_intx(model_lmer))$coefficients[2,1] - sd_vector[1]
pm_decline_model_all[1,3] <- summary(detrend_lmer_full_catyr_intx(model_lmer))$coefficients[2,1] + sd_vector[1]

# fill in matrix thru loop for every following year
yr_ct <- 39
for (i in 2:19){
  pm_decline_model_all[i,1] <- summary(detrend_lmer_full_catyr_intx(model_lmer))$coefficients[2,1]+
    summary(detrend_lmer_full_catyr_intx(model_lmer))$coefficients[yr_ct,1]
  pm_decline_model_all[i,2] <- summary(detrend_lmer_full_catyr_intx(model_lmer))$coefficients[2,1]+
    summary(detrend_lmer_full_catyr_intx(model_lmer))$coefficients[yr_ct,1] - sd_vector[i]
  pm_decline_model_all[i,3] <- summary(detrend_lmer_full_catyr_intx(model_lmer))$coefficients[2,1]+
    summary(detrend_lmer_full_catyr_intx(model_lmer))$coefficients[yr_ct,1] + sd_vector[i]
  yr_ct <- yr_ct + 1
}
# set col names
...
# vcov matrix
summary(detrend_lmer_full_catyr_intx(rural_monitors))
summary(detrend_lmer_full_catyr_intx(rural_model))
native_yr_vcov <- vcov(detrend_lmer_full_catyr_intx(rural_model))[c(2,seq(39,56)), c(2,seq(39,56))]
...
pm_decline_model_rural[1,1] <- summary(detrend_lmer_full_catyr_intx(rural_model))$coefficients[2,1]
pm_decline_model_rural[1,2] <- summary(detrend_lmer_full_catyr_intx(rural_model))$coefficients[2,1] - sd_vector[1]
pm_decline_model_rural[1,3] <- summary(detrend_lmer_full_catyr_intx(rural_model))$coefficients[2,1] + sd_vector[1]

# fill in matrix thru loop for every following year
yr_ct <- 39
for (i in 2:19){
  pm_decline_model_rural[i,1] <- summary(detrend_lmer_full_catyr_intx(rural_model))$coefficients[2,1]+
    summary(detrend_lmer_full_catyr_intx(rural_model))$coefficients[yr_ct,1]
  pm_decline_model_rural[i,2] <- summary(detrend_lmer_full_catyr_intx(rural_model))$coefficients[2,1]+
    summary(detrend_lmer_full_catyr_intx(rural_model))$coefficients[yr_ct,1] - sd_vector[i]
  pm_decline_model_rural[i,3] <- summary(detrend_lmer_full_catyr_intx(rural_model))$coefficients[2,1]+
    summary(detrend_lmer_full_catyr_intx(rural_model))$coefficients[yr_ct,1] + sd_vector[i]
  yr_ct <- yr_ct + 1
}
