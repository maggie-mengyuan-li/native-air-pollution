...
```{r}
setwd("/Users/maggieli/Dropbox/Native Air Pollution Paper/Paper/CodeCheck/Data/EPA_data_1999_2018")
...
```{r}
PM2_5_1999_2018_rural_clipped<-read.csv("/Users/maggieli/Dropbox/Native Air Pollution Paper/Paper/CodeCheck/Data/PM2_5_1999_2018_rural_clipped.txt", sep="")
...
IMPROVE_location_tbl <- read.csv("/Users/maggieli/Dropbox/Native Air Pollution Paper/Paper/CodeCheck/Data/IMPROVE_location_tbl.csv")
...
# setwd("/Users/maggieli/Dropbox/Native Air Pollution Paper/Paper/CodeCheck/Data/cb_2018_us_county_500k")
...
# setwd("/Users/maggieli/Dropbox/Native Air Pollution Paper/Paper/CodeCheck/Data/model_PM25")
...
counties_cluster <- read.csv("/Users/maggieli/Dropbox/Native Air Pollution Paper/Paper/CodeCheck/Data/clustershare.csv")
...
tribal.gdb <- "/Users/maggieli/Dropbox/Native Air Pollution Paper/Paper/CodeCheck/Data/Tribal_Boundaries_022117.gdb"
tribal.gdb
...
#          dsn = "/Users/maggieli/Dropbox/Native Air Pollution Paper/Paper/CodeCheck/Data/tribal48",
...
setwd("/Users/maggieli/Dropbox/Native Air Pollution Paper/Paper/CodeCheck/Data")
...
####3.1.3.3 Monitor coverage for cluster definition native/non-native counties
```{r}
...
sd_PM25_row_main <- data.frame(sd(native_avg_exp$avg_pm_all),
                               ...
                               sd(monitors_native_avgexp$avg_pm_all),
...
native_monitor_modelexp <- avg_modelPM25 %>% inner_join(monitors_native_avgexp) %>%
  filter(county_type == 1)

general_monitor_modelexp <- avg_modelPM25 %>% inner_join(monitors_general_avgexp) %>%
...
rural_general_modelexp <- avg_modelPM25 %>% filter(county_type == 0,
                                                   as.numeric(land_use) >= 4)
rural_native_monitor_modelexp <- avg_modelPM25 %>% inner_join(monitors_native_avgexp) %>%
...
dplyr::bind_rows(native_exp_final,native_avgdec)
...
#fill in NAs in movave column; have first Year be the first Year, 2nd Year be 2 Year moving avg
nonnative_modelpm_final$county_type <- "American Indian"
...
nonnative_avgdec_model$county_type <- "American Indian"
