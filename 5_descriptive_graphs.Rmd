...
predict(mod.all$gam, newdata = pred_df)
...
# add caption/title
grob_monitor_combined <- grobTree(textGrob("Measured", x=0.05,  y=0.1, hjust=0,gp=gpar(fontsize=24)))
...
# add caption/title
grob_model_combined <- grobTree(textGrob("Modeled", x=0.05,  y=0.1, hjust=0,gp=gpar(fontsize=24)))

# Plot & save
model_combined + annotation_custom(grob_model_combined)


ggsave("figures/updated_10.30/model_combined.png")
```
