...
ggsave("figures/updated_11.20/monitor_combined.png")

monitor_combined + annotation_custom(grob_monitor_data)
ggsave("figures/updated_11.20/monitor_combined_datasource.png")
...
ggsave("figures/updated_11.20/model_combined.png")

model_combined + annotation_custom(grob_model_data)
ggsave("figures/updated_11.20/model_combined_datasource.png")
